...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-&kj41k^m$371#zfpm))kgxdkww0hith-xn(d7jmzw*+7dt)6y(')
...
# nanobanana API
NANOBANANA_API_KEY = config('NANOBANANA_API_KEY', default='')
